            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <span className="flex items-center space-x-3 rtl:space-x-reverse">
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Filter Flex</span>
                    </span>
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        {
                            user && <><img src={user?.photoURL || 'https://i.ibb.co/D5rYfZw/307ce493-b254-4b2d-8ba4-d12c080d6651.jpg'} alt="user photo" className='rounded-full size-10 hover:ring-blue-500' />
                                <button onClick={() => logout()} className='bg-blue-600 text-white p-2 font-semibold text-sm rounded-lg mx-1'>Sign Out</button></>
                        }
